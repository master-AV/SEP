...
//
////                .requestMatchers("/extension/**").hasAuthority("ADMIN")
////                .requestMatchers("/certificate/**").hasAuthority("ADMIN")
...
//        http.csrf().disable();
//        http.headers().frameOptions().sameOrigin(); // zbog h2-console
//
...
//    }
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        ...
        return (web) -> web.ignoring()
                ...
                .requestMatchers(HttpMethod.POST, "/id/**")
