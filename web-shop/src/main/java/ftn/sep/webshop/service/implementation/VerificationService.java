...
import ftn.sep.webshop.dto.VerifyMailDTO;
import ftn.sep.webshop.exception.EntityNotFoundException;
import ftn.sep.webshop.exception.MailCannotBeSentException;
import ftn.sep.webshop.exception.WrongVerifyTryException;
import ftn.sep.webshop.repository.VerificationRepository;
...
public class VerificationService {
    ...
    public void create(String email) throws IOException, MailCannotBeSentException {
        ...
        this.sendVerificationEmail(new VerifyMailDTO(securityCode, registrationVerification.getHashedId(), email));
    }
