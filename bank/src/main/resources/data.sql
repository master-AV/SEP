insert into account(pan, security_code, card_holder_name, expiration_date, reserved_money, available_money) values
                                                                ('0123', '123', 'OTP', '2028-03-31', 0, 100000);
...
insert into account(pan, security_code, card_holder_name, expiration_date, reserved_money, available_money) values
('0321', '123', 'Petar Petrovic', '2024-03-31', 100, 5000);
...
insert into sales_account(merchant_id, merchant_password, account_id) values ('1', '123', 1);
