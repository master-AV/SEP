...
-- insert into account(pan, security_code, card_holder_name, expiration_date, reserved_money, available_money) values ('6ZQ8ERAZqeuvpciK/6kfkQ==', '77SoRnEHFh5al4Pq5/vywQ==', 'Milos Ceca', '2024-03-31', 100, 5000);
-- insert into account(pan, security_code, card_holder_name, expiration_date, reserved_money, available_money) values ('R7F4lxkD6bPo/fWJvl5jng==', '77SoRnEHFh5al4Pq5/vywQ==', 'Jovan Ceca', '2024-03-31', 100, 5000);
